...
public class DecimalTest {//传入十进制的整数，中间存储类型为整数二进制补码；传入十进制的浮点数，中间存储类型为二进制浮点数；传入二进制浮点数，中间存储类型二进制浮点数

	@Test
	public void testInteger1() {//整数，浮点数，浮点数的二进制，整数的bcd，整数的补码
	...
	@Test
	public void testFloat2() {//这个是不是有问题？
		TestUnit expected = new TestUnit(null,
				""+Float.MAX_VALUE,
